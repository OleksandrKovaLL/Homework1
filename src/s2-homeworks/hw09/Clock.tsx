...
function Clock() {
    ...
    const getNameOfWeekday = (day: number) => {
    ...
    const stringTime = `${hour}:${minute}:${seconds}`  // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    ...
    const stringDay = getNameOfWeekday(date.getDay())
